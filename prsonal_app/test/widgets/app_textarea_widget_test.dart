...
void main() {
  group('AppTextarea', () {
    ...
    testWidgets('AC-002: Widget renders the configured number of rows (maxLines equals rows)',
        (tester) async {
    ...
    testWidgets('AC-004: Widget is non-editable when enabled is false', (tester) async {
