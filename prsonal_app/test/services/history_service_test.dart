...
void main() {
  ...
  SeedSet strengthSet({
    ...
    estimated1RM: skipped
        ? null
        : estimatedOneRepMax(effectiveWeight: weight, reps: reps),
  ...
  group('HistoryService', () {
    ...
    test(
      ...
      () async {
        final id = await seedSession(
          startedAt: DateTime(2026, 6, 23),
          sets: [strengthSet(index: 0, name: 'Bench', reps: 8, weight: 80)],
        );
    ...
    test(
      ...
      () async {
        ...
        final setId = (await service.getDetail(
          id,
        )).exercises.single.sets.single.id;
        ...
        expect(
          ...
          closeTo(estimatedOneRepMax(effectiveWeight: 85, reps: 10), 1e-9),
        );
      },
    );
