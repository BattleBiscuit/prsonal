  ...
  group('WorkoutSession', () {
    test(
      ...
      () {
        ...
        expect(
          SessionStatus.values.byName('completed'),
          SessionStatus.completed,
        );
        expect(
          () => SessionStatus.values.byName('paused'),
          throwsArgumentError,
        );
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(
          formatSessionDuration(start, start.add(const Duration(minutes: 47))),
          '47m',
        );
        expect(
          formatSessionDuration(
            start,
            start.add(const Duration(hours: 1, minutes: 12)),
          ),
          '1h 12m',
        );
      },
