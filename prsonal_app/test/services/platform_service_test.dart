...
void main() {
  group('PlatformService (fake)', () {
    test('AC-001: FakePlatformService records hapticTap, hapticPR and hapticSuccess calls',
        () async {
    ...
    test('AC-002: scheduleRestComplete records the requested duration and cancelRestComplete clears the pending rest notification',
        () async {
      final fake = FakePlatformService();
    ...
    test('AC-003: enableSessionWakelock and disableSessionWakelock toggle a recorded wakelock flag',
        () async {
      final fake = FakePlatformService();
