...
Widget _wrap(Widget child) =>
    MaterialApp(home: Scaffold(body: SizedBox(width: 320, height: 240, child: child)));

void main() {
  group('VolumeChart', () {
    testWidgets('AC-001: Widget renders a bar chart for the provided data', (tester) async {
    ...
    testWidgets('AC-002: Widget shows an empty state when there is no data', (tester) async {
      await tester.pumpWidget(_wrap(const VolumeChart(data: [])));
