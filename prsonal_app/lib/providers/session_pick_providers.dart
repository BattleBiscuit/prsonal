...
export '../services/plans_service.dart' show PlanView, PlanEntryView, UnplannedRoutine;

/// Backing async provider — calls the real service.
final _activePlansViewFutureProvider = FutureProvider<List<PlanView>>((ref) async {
...
/// Backing async provider — calls the real service.
final _unplannedRoutinesFutureProvider = FutureProvider<List<UnplannedRoutine>>((ref) async {
  final service = ref.watch(plansServiceProvider);
