...
void main() {
  group('SetRow', () {
    testWidgets('AC-001: An upcoming set renders its set number and planned target',
        (tester) async {
      await tester.pumpWidget(_wrap(const SetRow(
        index: 2,
    ...
    testWidgets('AC-002: The active set renders editable primary and secondary inputs and a complete checkbox',
        (tester) async {
      await tester.pumpWidget(_wrap(SetRow(
        index: 0,
        kind: ExerciseType.strength,
    ...
    testWidgets('AC-003: A completed set renders its logged values in a checked state',
        (tester) async {
      await tester.pumpWidget(_wrap(const SetRow(
        index: 0,
        kind: ExerciseType.strength,
    ...
    testWidgets('AC-004: A completed set that set a personal record renders a PR indicator',
        (tester) async {
      await tester.pumpWidget(_wrap(const SetRow(
        index: 0,
        kind: ExerciseType.strength,
    ...
    testWidgets('AC-005: A skipped set renders a skipped treatment', (tester) async {
      await tester.pumpWidget(_wrap(const SetRow(
        index: 0,
        kind: ExerciseType.strength,
    ...
    testWidgets('AC-006: Tapping the active set\'s checkbox invokes onToggleComplete',
        (tester) async {
      var toggled = false;
      await tester.pumpWidget(_wrap(SetRow(
        index: 0,
