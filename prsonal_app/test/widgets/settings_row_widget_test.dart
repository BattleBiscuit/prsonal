...
void main() {
  group('SettingsRow', () {
    testWidgets('AC-001: Widget renders the title and subtitle', (
      tester,
    ) async {
    ...
    testWidgets('AC-002: Widget renders a trailing widget when provided', (
      tester,
    ) async {
      await tester.pumpWidget(
        _wrap(
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.pumpWidget(
          _wrap(
            SettingsRow(title: 'Export backup', onTap: () => tapped = true),
          ),
        );
