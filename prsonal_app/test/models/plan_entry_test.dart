...
void main() {
  group('PlanEntry', () {
    test('AC-001: dayOfWeekLabel returns the three-letter weekday for 0–6 as Mon, Tue, Wed, Thu, Fri, Sat, Sun',
        () {
      expect(
    ...
    test('AC-002: dayOfWeekLabel returns "·" when dayOfWeek is null (unscheduled)',
        () {
      expect(dayOfWeekLabel(null), '·');
    });

    test('AC-003: validateDayOfWeek accepts null and integers 0 through 6 and rejects any value outside that range',
        () {
