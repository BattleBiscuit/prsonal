...
void main() {
  group('LibraryExerciseCard', () {
    testWidgets('AC-001: Widget renders the name and a type badge', (tester) async {
    ...
    testWidgets('AC-002: Widget renders the primary muscles label', (tester) async {
      await tester.pumpWidget(_wrap(LibraryExerciseCard(
        name: 'Bench Press',
        type: ExerciseType.strength,
        musclesLabel: 'Chest, Shoulders',
    ...
    testWidgets('AC-003: Widget renders a PR chip when prLabel is provided and omits it when null',
        (tester) async {
      await tester.pumpWidget(_wrap(LibraryExerciseCard(
        name: 'Bench Press',
        type: ExerciseType.strength,
    ...
    testWidgets('AC-004: Widget calls onTap when the card body is tapped', (tester) async {
      var tapped = false;
      await tester.pumpWidget(_wrap(LibraryExerciseCard(
        name: 'Bench Press',
        type: ExerciseType.strength,
    ...
    testWidgets('AC-005: Widget calls onDelete when the delete button is tapped',
        (tester) async {
      var deleted = false;
      await tester.pumpWidget(_wrap(LibraryExerciseCard(
        name: 'Bench Press',
