...
void main() {
  group('RoutineCard', () {
    testWidgets('AC-001: Widget renders the routine name and meta line', (tester) async {
    ...
    testWidgets('AC-002: Widget renders the notes preview when provided and omits it when null',
        (tester) async {
      await tester.pumpWidget(_wrap(RoutineCard(
        name: 'Push Day A',
