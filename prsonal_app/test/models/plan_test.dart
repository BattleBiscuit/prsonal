...
void main() {
  group('Plan', () {
    test('AC-001: PlanStatus resolves to and from its stored name (active, archived); an unknown name throws',
        () {
    ...
    test('AC-002: validatePlanName returns false for an empty or whitespace-only name and true otherwise',
        () {
    ...
    test('AC-003: defaultPlanStatus is active (a newly created plan is active)', () {
