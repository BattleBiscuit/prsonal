...
void main() {
  group('SetTarget', () {
    test('AC-001: SetTarget.strength() defaults to 10 reps, 0 kg, not bodyweight, and 90 seconds rest',
        () {
    ...
    test('AC-002: SetTarget.cardio() defaults to 20 minutes duration, level 1, and 0 seconds rest',
        () {
    ...
    test('AC-003: a strength SetTarget round-trips through JSON preserving reps, weight, isBodyweight and restSeconds',
        () {
      final s = SetTarget.strength()
          .copyWith(reps: 8, weight: 82.5, isBodyweight: true, restSeconds: 120);
    ...
    test('AC-004: a cardio SetTarget round-trips through JSON preserving duration, level and restSeconds',
        () {
      final s = SetTarget.cardio().copyWith(duration: 30, level: 5, restSeconds: 60);
      final restored = SetTarget.fromJson(s.toJson());
    ...
    test('AC-006: validateSets returns false for an empty list and true when at least one set is present',
        () {
