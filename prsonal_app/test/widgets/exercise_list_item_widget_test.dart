...
void main() {
  group('ExerciseListItem', () {
    testWidgets('AC-001: Widget renders the exercise name and sets summary', (tester) async {
      await tester.pumpWidget(_wrap(ExerciseListItem(
        name: 'Bench Press',
    ...
    testWidgets('AC-003: Widget calls onTap when the body is tapped', (tester) async {
      var tapped = false;
      await tester.pumpWidget(_wrap(ExerciseListItem(
        name: 'Bench Press',
        setsSummary: '3 sets',
