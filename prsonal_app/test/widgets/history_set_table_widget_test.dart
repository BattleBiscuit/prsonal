...
void main() {
  group('HistorySetTable', () {
    testWidgets('AC-001: Widget renders the exercise name and a row per set with planned and actual values',
        (tester) async {
      await tester.pumpWidget(_wrap(const HistorySetTable(exerciseName: 'Bench Press', rows: _rows)));
    ...
    testWidgets('AC-004: In editing mode the actual values become editable inputs',
        (tester) async {
      await tester.pumpWidget(
          _wrap(const HistorySetTable(exerciseName: 'Bench Press', rows: _rows, editing: true)));
