...
void main() {
  group('SessionHeader', () {
    testWidgets('AC-001: Widget renders the routine name', (tester) async {
      await tester.pumpWidget(_wrap(SessionHeader(
    ...
    testWidgets('AC-002: Widget renders the elapsed time formatted as M:SS under an hour',
        (tester) async {
      await tester.pumpWidget(_wrap(SessionHeader(
        routineName: 'Push Day A',
        elapsed: const Duration(minutes: 12, seconds: 31),
    ...
    testWidgets('AC-003: Widget calls onQuit when the quit action is tapped', (tester) async {
      var quit = false;
      await tester.pumpWidget(_wrap(SessionHeader(
        routineName: 'Push Day A',
    ...
    testWidgets('AC-004: Widget calls onFinish when the finish action is tapped',
        (tester) async {
      var finished = false;
      await tester.pumpWidget(_wrap(SessionHeader(
        routineName: 'Push Day A',
