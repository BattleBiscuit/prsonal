...
Future<_MockLibraryService> _pump(WidgetTester tester, List<LibraryExercise> exercises) async {
...
void main() {
  group('LibraryScreen', () {
    testWidgets('AC-001: Lists exercises, each with its type and primary muscles', (tester) async {
      await _pump(tester, [_ex('e1', 'Bench Press'), _ex('e2', 'Squat')]);
      expect(find.text('Bench Press'), findsOneWidget);
      expect(find.text('Squat'), findsOneWidget);
    });

    testWidgets('AC-002: Typing in the search filters the list', (tester) async {
      await _pump(tester, [_ex('e1', 'Bench Press'), _ex('e2', 'Squat')]);
    ...
    testWidgets('AC-003: Tapping the FAB opens the exercise form to create a new exercise',
        (tester) async {
    ...
    testWidgets('AC-004: Tapping a card opens the exercise form to edit it', (tester) async {
      await _pump(tester, [_ex('e1', 'Bench Press')]);
    ...
    testWidgets('AC-005: Tapping delete confirms and then removes the exercise', (tester) async {
    ...
    testWidgets('AC-006: Shows an empty state when the library is empty', (tester) async {
