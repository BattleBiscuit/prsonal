...
void main() {
  group('AppModal', () {
    testWidgets('AC-001: Widget renders the title when provided', (tester) async {
    ...
    testWidgets('AC-003: Widget renders the actions when provided', (tester) async {
      await tester.pumpWidget(
        _wrap(const AppModal(
    ...
    testWidgets('AC-004: Widget calls onClose when the close button is tapped',
        (tester) async {
      var closed = false;
      await tester.pumpWidget(
        _wrap(AppModal(
